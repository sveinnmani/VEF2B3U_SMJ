...
document.getElementById("mainThing").firstElementChild.appendChild(divPizzaName);
//divSize
divSize.appendChild(textSize);
document.getElementById("mainThing").firstElementChild.appendChild(divSize);
//divPrice
divPrice.appendChild(textPrice);
document.getElementById("mainThing").firstElementChild.appendChild(divPrice);
//divToppingContainer
document.getElementById("mainThing").firstElementChild.appendChild(divToppingCont);
//spanTopping
spanTopping1.appendChild(textTopping1);
document.getElementsByTagName("DIV")[4].appendChild(spanTopping1);
spanTopping2.appendChild(textTopping2);
document.getElementsByTagName("DIV")[4].appendChild(spanTopping2);
spanTopping3.appendChild(textTopping3);
document.getElementsByTagName("DIV")[4].appendChild(spanTopping3);